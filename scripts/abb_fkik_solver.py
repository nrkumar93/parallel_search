...
import pdb
import numpy as np
import python.brain2.bullet.problems as problems
from python.brain2.bullet.interface import BulletInterface
from python.brain2.bullet.ik import BulletIKSolver
from python.brain2.robot.domain import RobotDomainDefinition
import python.brain2.utils.axis as axis
from python.brain2.utils.pose import make_pose
from python.brain2.utils.info import logwarn


class ABBFkIkSolver():

    def __init__(self, assets_path, visualize=False):
        self.ik = BulletIKSolver()
        self.iface = BulletInterface(gui=visualize, add_ground_plane=False)
        self.robot = self.load_ABB(self.iface, assets_path)
